...
| **6**  | **Benchmarking**                        | Performance testing performance-sensitive endpoints using load testing and CI smoke tests.                                                                                                  | k6, wrk, hyperfine                           | CI smoke tests are required for critical endpoints.                          |
